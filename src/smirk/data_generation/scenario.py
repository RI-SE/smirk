...
import smirk.data_generation.utils as data_generation_utils
from smirk.simulators.prosivic.objects.pedestrian import PedestrianAppearance
from smirk.simulators.prosivic.objects.simple_object import SimpleObjectType
...
class Scenario:
    ...
    id: str = dataclasses.field(
        default_factory=data_generation_utils.generate_scenario_id
    )
